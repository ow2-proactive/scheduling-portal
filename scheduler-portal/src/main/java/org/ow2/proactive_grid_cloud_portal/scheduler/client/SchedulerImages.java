...
public interface SchedulerImages extends ClientBundle {
    ...
    SchedulerImages instance = GWT.create(SchedulerImages.class);
    ...
    @Source("images/scheduler_starting_16.png")
    ImageResource scheduler_starting_16();
