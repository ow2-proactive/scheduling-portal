...
public class ThirdPartyCredentialsWindow implements SchedulerListeners.ThirdPartyCredentialsListener {
    ...
    public ThirdPartyCredentialsWindow(final SchedulerController controller) {
        ...
        Label label = new Label("Third-party credentials are key-value pairs saved on server side. They can be accessed from tasks.");
        label.setHeight(30);
        ...
        final CheckboxItem longValueCheck = new CheckboxItem("longValueCheck", "Multiline credential");
        ...
        addCredential.setMembers(addEntryForm, longValueCheckForm, space, addButton);
