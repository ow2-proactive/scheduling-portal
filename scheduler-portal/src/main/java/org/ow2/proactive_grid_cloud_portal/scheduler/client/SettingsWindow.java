...
public class SettingsWindow {
    ...
    private void build() {
        ...
        DataSourceIntegerField refreshTime = new DataSourceIntegerField("refreshTime", "Job list refresh rate (ms)");
        ...
        DataSourceIntegerField liveLogTime = new DataSourceIntegerField("logTime", "Live log refresh rate (ms)");
        ...
        DataSourceIntegerField tagSuggestionSize = new DataSourceIntegerField("tagSuggestionsSize",
                                                                              "Max tag suggestions");
        ...
        DataSourceIntegerField tagSuggestionDelay = new DataSourceIntegerField("tagSuggestionsDelay",
                                                                               "Tag suggestions refresh time (ms)");
